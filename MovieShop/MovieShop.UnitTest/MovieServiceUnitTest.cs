...
namespace MovieShop.UnitTest
{
    ...
    public class MovieServiceUnitTest
    {
        ...
        {
            //SUT(system under test) Movie Service -> GetTopRevenueMovies

            //Arrange - mock objects, data, methods, etc
            //_sut = new MovieService(new MockMovieRepository()); // for MS Test

            //Act
            var movies = await _sut.GetTopRevenueMovies();

            //check actual output with expected data
            //AAA - arrange act assert, should follow for every unit testing
    ...
    //    {
    //        //this method will get done with fake data
    ...
    //    public Task<Movie> GetMovieByTitle(string movieTitle)
    //    {
    //        throw new NotImplementedException();
    //    }
